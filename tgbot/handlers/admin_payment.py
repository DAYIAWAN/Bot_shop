...
from tgbot.keyboards.inline_admin import payment_choice_final
...
async def payment_systems(message: Message, state: FSMContext):
    ...
    await message.answer("<b>🖲 Выберите способы пополнений</b>", reply_markup=payment_choice_final())
...
async def payment_systems_edit(call: CallbackQuery):
    ...
    await call.message.edit_text("<b>🖲 Выберите способы пополнений</b>", reply_markup=payment_choice_final())
